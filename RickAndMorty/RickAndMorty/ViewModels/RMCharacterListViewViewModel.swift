...
extension RMCharacterListViewViewModel: UIScrollViewDelegate {
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        /// To avoid calling data multiple times !isLoadingCharacters added.
        guard shouldShowLoadMoreIndicator, !isLoadingCharacters else {
            return
        }
        ...
        /// Where it should load more character
